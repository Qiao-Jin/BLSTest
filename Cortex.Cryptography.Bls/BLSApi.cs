...
namespace Cortex.Cryptography
{
    ...
    public class BLSApi
    {
        ...
        public byte[] Aggregate(IEnumerable<byte[]> signatures, int[] weights)
        {
            ...
            var success = _bls.TryAggregateSignatures(signaturesSpan, weights, aggregate, out var bytesWritten);
